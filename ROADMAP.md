...
這個檔案作為 roadmap 索引，保留目前方向、phase 進度與尚未完成的工作。

歷史 phase 細節可參考 `archive/README.md`。

phase 1 到 phase 6 已經把這個 repo 從單一工具導向的 manager，收斂成以 `canonical-skills/` 為唯一 canonical source tree、可 render 到 Codex 與 Claude 的 skill-forge。
...
7. [Phase 5: 將 skill-forge 發布為容器化 CLI](archive/phases/phase5.md)
...
10. [Phase 8: Canonicalize Maintainer Workflows and Improve Maintainer UX](archive/phases/phase8.md)
...
- Phase 8: 核心工作已完成，剩餘收尾項目持續整理中（maintainer skills 已納入 canonical source，maintainer terminal 文件與 metadata/sync 工具已補齊）
...
- [x] 改寫 README 首屏，明確主打 enterprise governance 與 vendor portability
- [x] 補一個對外一句話定位與使用情境圖
- [x] 補 canonical source -> Codex / Claude render 的示意圖或 demo
- [x] 補「為什麼不是 marketplace」與「和官方 skills 能力如何分工」的說明
- [x] 補一份面向團隊 / 公司導入的 adoption guide
